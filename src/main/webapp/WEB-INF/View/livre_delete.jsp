  ...
  <body>
    ...
    <main>
      <section class="content">
        ...
        <div class="row">
          <div class="container">
            <h5>Suppression du livre no ${id}</h5> <!-- TODO : afficher l'id du livre au lieu de 42 -->
            <div class="row">
              <p>etes-vous sur de vouloir supprimer le livre ${livre.getTitre()} de ${livre.getAuteur()} (code
                ${livre.getIsbn()}) ?</p> <!-- TODO : compl�ter les trois informations ci-contre -->
