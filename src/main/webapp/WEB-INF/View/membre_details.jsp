						...
						<div class="row">
							<form action="/TP3Ensta/membre_details?id=${id}" method="post" class="col s12">
								<div class="row">
									...
									<div class="input-field col s4">
										<select name="abonnement" class="browser-default">
											...
											<option value="BASIC" ${(membre.getAbonnement()=="BASIC" ) ? " selected"
												: "" }>
												Abonnement BASIC</option>
											<option value="PREMIUM" ${(membre.getAbonnement()=="PREMIUM" ) ? " selected"
												: "" }>Abonnement PREMIUM</option>
											<option value="VIP" ${(membre.getAbonnement()=="VIP" ) ? " selected" : "" }>
								...
								<div class="row">
									...
									<div class="input-field col s6">
										<input id="telephone" type="tel" value="${membre.getTelephone()}"
											name="telephone">
